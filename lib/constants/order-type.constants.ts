 ...
 * - "Đổi vỏ"
 */
export const getOrderTypePrefix = (ordertypeName: string | null | undefined): string | null => {
 ...
 */
export const mapOrderTypeNameToCode = (ordertypeName: string | null | undefined): string | null => {
  if (!ordertypeName) return null;
